...
mv ${BASE_PATH}/output_data/${OUTPUT_HEADER}.out/output_data/dual_modelNonOverlappingWorms_high_dose.csv ${BASE_PATH}/output_data/${PROJECT_TITLE}_summary_data/${OUTPUT_HEADER}_NonOverlappingWorms_high_dose.csv
