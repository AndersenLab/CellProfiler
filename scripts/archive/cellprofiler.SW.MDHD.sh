...
mv ${OUTPUT_DATA}/${OUTPUT_HEADER}.out/output_data/*NonOverlappingWorms_MDHD.csv                    ${OUTPUT_DATA}/${OUTPUT_HEADER}.out/output_data/${OUTPUT_HEADER}_NonOverlappingWorms_MDHD.csv
mv ${OUTPUT_DATA}/${OUTPUT_HEADER}.out/output_data/${OUTPUT_HEADER}_NonOverlappingWorms_MDHD.csv    ${OUTPUT_DATA}/${PROJECT_TITLE}_summary_data/NonOverlappingWorms_Data
...
mv ${OUTPUT_DATA}/${OUTPUT_HEADER}.out/output_data/*OverlappingWorms_MDHD.csv                     ${OUTPUT_DATA}/${OUTPUT_HEADER}.out/output_data/${OUTPUT_HEADER}_OverlappingWorms_MDHD.csv
mv ${OUTPUT_DATA}/${OUTPUT_HEADER}.out/output_data/${OUTPUT_HEADER}_OverlappingWorms_MDHD.csv     ${OUTPUT_DATA}/${PROJECT_TITLE}_summary_data/OverlappingWorms_Data
echo "
#######################################################
