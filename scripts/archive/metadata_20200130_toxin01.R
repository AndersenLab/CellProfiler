require(tidyverse)
setwd("/Volumes/ECA_Image/Tim/20200130_Toxin01A/20200130-toxin01A/")
...
images$Image_PathName_RawBF <- "/projects/b1059/software/CellProfiler/projects/20200130_toxin01/raw_images" ## CLUSTER
