...
# Making metadata on quest - thanks coronavirus :/ 
setwd("/projects/b1059/software/CellProfiler/projects/20200313_toxin07A/raw_images")
...
images$Image_PathName_RawBF <- "/projects/b1059/software/CellProfiler/projects/20200313_toxin07A/raw_images" ## CLUSTER
...
filename <- paste(paste(images$Metadata_Date, 
                  ...
                  sep = "_")
write.csv(x = images,
          file = paste("/projects/b1059/software/CellProfiler/metadata",
                       filename,".csv",sep = ""),
          row.names = F)
