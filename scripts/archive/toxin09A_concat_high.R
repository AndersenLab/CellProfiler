...
require(tidyverse)
require(reshape2)
setwd("/projects/b1059/software/CellProfiler/projects/20200711_toxin09A/output_data/20200711_toxin09A_summary_data/NonOverlappingWorms_Data")
metadata <- read_csv("/projects/b1059/software/CellProfiler/metadata/20200711_toxin09A_metadata.csv")
...
setwd("/projects/b1059/software/CellProfiler/projects/20200711_toxin09A/output_data/20200711_toxin09A_summary_data")
save.image("toxin09A_high.RData")
