require(tidyverse)
setwd("/Volumes/ECA_Image/sam/20200307/20200307-toxin06A/")
...
images$Image_PathName_RawBF <- "/projects/b1059/software/CellProfiler/projects/20200307_toxin06A/raw_images" ## CLUSTER
...
filename <- paste(paste(images$Metadata_Date, 
                  ...
                  sep = "_")
write.csv(x = images,
          file = paste("~/Google Drive/git/20200307_toxin06A/metadata/",
                       filename,".csv",sep = ""),
          row.names = F)
