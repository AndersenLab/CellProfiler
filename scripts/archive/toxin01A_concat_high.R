...
require(tidyverse)
require(reshape2)
setwd("/projects/b1059/software/CellProfiler/projects/20200305_toxin01A/output_data/20200305_toxin01A_summary_data/NonOverlappingWorms_Data/")
...
setwd("/projects/b1059/software/CellProfiler/projects/20200305_toxin01A/output_data/20200305_toxin01A_summary_data/")
save.image("toxin01A_high.RData")
