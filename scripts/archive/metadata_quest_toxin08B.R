...
setwd("/projects/b1059/software/CellProfiler/projects/20200626_toxin08B/raw_images")
...
images$Image_PathName_RawBF <- "/projects/b1059/software/CellProfiler/projects/20200626_toxin08B/raw_images" ## CLUSTER
...
filename <- paste(paste(images$Metadata_Date, 
                  ...
                  "metadata",
                  sep = "_")
setwd("/projects/b1059/software/CellProfiler/metadata")
